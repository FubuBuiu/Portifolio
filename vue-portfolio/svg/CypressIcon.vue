  ...
  >
    <defs>
      ...
      >
        ...
        <stop offset="100%" :stop-color="isLightIcon ? '#92DFBF' : '#315C55'" />
      </linearGradient>
      <linearGradient
      ...
      >
        <stop offset="0%" :stop-color="isLightIcon ? '#74D6AD' : '#4FB38D'" />
        <stop offset="100%" :stop-color="isLightIcon ? '#74D6AD' : '#97DEC0'" />
      </linearGradient>
      <linearGradient
    ...
    <path
      :fill="isLightIcon ? 'white' : '#09293F'"
      d="m198.341 85.726l-24.712 62.729l-24.877-62.729h-20.35l34.888
    85.617l-24.822 60.385l17.792 3.55l61.309-149.552z"
    />
    <path
...
export default Vue.extend({
  props: {
    ...
    isLightIcon: { type: Boolean, default: false },
  },
});
</script>
